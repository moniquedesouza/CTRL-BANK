...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 15-Maio-2019 às 01:14
...
INSERT INTO `acoes` (`id`, `nome`, `cod`, `taxa`, `link`) VALUES
(1, 'Tesouro Selic 2019', 'LFTB4', 0.6, 'LFTB4.html'),
(2, 'Itaú Unibanco 2019', 'ITUB4', 0.9, ''),
(3, 'Ambev 2019', 'ABEV3', 0.1, '');
...
INSERT INTO `investimentos` (`id`, `id_acao`, `id_conta`, `data_comeco`, `data_termino`, `investido`) VALUES
(1, 1, 4, '2001-01-01', '2001-01-01', 350),
(2, 2, 4, '2001-01-01', '2001-01-01', 100);
COMMIT;
